...
## Purpose
Build a Pydantic AI multi-agent system where a primary Research Agent uses Brave Search API and has an Email Draft Agent (using Gmail API) as a tool. This demonstrates agent-as-tool pattern with external API integrations. Follows context engineering principles for one-pass implementation success.
...
- url: https://docs.anthropic.com/en/docs/claude-code
  why: Claude Code agent orchestration
- url: https://ai.pydantic.dev/
  why: PydanticAI agent framework
- url: https://platform.openai.com/docs/overview
  why: OpenAI API integration
- url: https://jina.ai/reader/
  why: Jina Reader API for content extraction
- url: https://jina.ai/search/
  why: Jina Search API for SERP analysis
